...
var jaeger = require('pomelo-rpc').tracer;
...
pro.globalHandle = function(msg, session, cb) {
  ...
  var span = jaeger.startSpan(msg, routeRecord.handler + '::' + routeRecord.method, {
    'span.kind': 'server'
  });

  cb = function(err, resp, opts) {
    span.finish(err);
    utils.invokeCallback(originCb, err, resp, opts);
  };
